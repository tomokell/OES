...
These licence terms apply to all licences granted by THE CHANCELLOR, MASTERS AND SCHOLARS OF THE UNIVERSITY OF OXFORD whose administrative offices are at University Offices, Wellington Square, Oxford OX1 2JD, United Kingdom (the “University”) for use of "Optimal Encoding Scheme with Off-resonance Correction for Pseudocontinuous Arterial Spin Labeling" (“the Software”) through this website http://github.com/ (the ”Website”). 
